...
public class MultipleChecking {
	...
	private void checking(String user,String key) throws InterruptedException {
	...
	private Object[][] datasFromExcel() throws IOException {
		...
		File f = new File(
				"C:\\Users\\Balaji.p\\eclipse-workspace\\Interiors\\DataStorage\\Login credentials for proshop.xlsx");
		...
		Cell c0002 = r3.getCell(1);
		String k0001 = c0002.getStringCellValue();
		
		
		Row r4 = s.getRow(5);
		Cell c00001 = r4.getCell(0);
		String u00001 = c00001.getStringCellValue();
		Cell c00002 = r3.getCell(1);
		String k00001 = c00002.getStringCellValue();
